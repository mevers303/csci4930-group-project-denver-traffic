...
## Github
[https://github.com/mevers303/csci4930-group-project-denver-traffic](https://github.com/mevers303/csci4930-group-project-denver-traffic)

## What to look at
The `evaluate.ipynb` contains the meaninful results and evaluation of models.

## Project Structure

- `project.ipynb`: Contains the primary data cleaning pipeline and extensive model grid searches.  This is the finalized version of the code.  I was using the various code boxes as needed, it can be run sequentially but the grid searches will take several hours.
